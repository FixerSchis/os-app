...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "event_type",
            sa.Enum("mainline", "sanctioned", "online", name="eventtype", native_enum=False),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "body_hits_type",
            sa.Enum("locational", "global", name="bodyhitstype", native_enum=False),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("pending", "completed", name="downtimestatus", native_enum=False),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PUBLISHED", "PENDING", name="wikipageversionstatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("invention", "artefact", name="researchtype", native_enum=False),
            nullable=False,
        ),
        sa.Column("description", sa.Text(), nullable=True),
    ...
    op.create_table(
        "character_research_stage_requirement",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("character_research_stage_id", sa.Integer(), nullable=False),
        sa.Column("requirement_id", sa.Integer(), nullable=False),
        sa.Column("progress", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["character_research_stage_id"],
            ["character_research_stage.id"],
        ),
        sa.ForeignKeyConstraint(
            ["requirement_id"],
            ["research_stage_requirement.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
    )
