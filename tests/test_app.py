...
def test_has_enter_downtime_packs_context_processor_no_packs(app, test_client, authenticated_user, db):
...
def test_has_enter_downtime_packs_context_processor_with_pack(app, test_client, authenticated_user, downtime_pack, db):
...
def test_has_research_projects_context_processor_no_projects(app, test_client, authenticated_user, db):
...
def test_has_research_projects_context_processor_with_project(app, test_client, authenticated_user, character_research, db):
