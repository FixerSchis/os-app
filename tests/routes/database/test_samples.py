...
def test_create_sample_success(test_client, admin_user, db):
    ...
    response = test_client.post('/db/samples/create', data={
        'name': 'Test Sample',
        'type': 'generic',
...
def test_create_sample_form_post(test_client, admin_user, db):
    ...
    with test_client.session_transaction() as session:
        session['_user_id'] = admin_user.id
        session['_fresh'] = True
    response = test_client.post('/db/samples/new', data={
        'name': 'Form Sample',
        'type': 'life',
...
def test_edit_sample_form_post(test_client, admin_user, db):
    ...
    with test_client.session_transaction() as session:
        session['_user_id'] = admin_user.id
        session['_fresh'] = True
    response = test_client.post(f'/db/samples/{sample.id}/edit', data={
        'name': 'Edited Sample',
        'type': 'life',
