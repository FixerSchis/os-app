...
mod_type_restrictions = db.Table('mod_type_restrictions',
...
class Mod(db.Model):
    ...
    item_types = db.relationship('ItemType', secondary=mod_type_restrictions, backref=db.backref('mods', lazy='dynamic'))
