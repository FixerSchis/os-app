...
class DowntimePack(db.Model):
    ...
    other = Column(JSON, default=str)  # Free-text field for other items (game team)
    player_other = Column(JSON, default=str)  # Free-text field for other items (players)
    ...
    def to_dict(self):
        return {
            ...
            "other": self.other,
            "player_other": self.player_other,
