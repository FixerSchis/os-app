    ...
    if request.method == 'POST':
        ...
        if User.query.count() == 0:
            ...
            try:
                ...
                flash('A verification email has been sent to your email address. Please check your inbox.')
...
def forgot_password():
    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            flash('A password reset email has been sent if this email is registered.', 'info')
