...
def list():
    ...
    return render_template('rules/medicaments/list.html', medicaments=medicaments, can_edit=can_edit)
...
def edit(id):
    ...
    return render_template('rules/medicaments/edit.html', medicament=medicament, initial_title=initial_title)
