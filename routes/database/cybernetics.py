...
def create():
    ...
    if request.method == 'POST':
        ...
        adds_engineering_downtime = request.form.get('adds_engineering_downtime', type=int, default=0)
        ...
        if not name or neural_shock_value is None or not wiki_slug:
            ...
            return render_template('rules/cybernetics/edit.html', initial_title='', science_types=ScienceType.values())
...
def edit(id):
    ...
    if request.method == 'POST':
        ...
        if not name or neural_shock_value is None or not wiki_slug:
            flash('All fields are required', 'error')
            return render_template('rules/cybernetics/edit.html', cyber=cyber, initial_title=initial_title, science_types=ScienceType.values())
