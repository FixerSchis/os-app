...
def list():
    ...
    return render_template('rules/exotic_substances/list.html', substances=substances, can_edit=can_edit, type_friendly_names=type_friendly_names)
...
def create():
    ...
    return render_template('rules/exotic_substances/edit.html', types=types, wiki_pages=wiki_pages, ScienceType=ScienceType)
...
def edit(id):
    ...
    types = [t for t in ScienceType]
    wiki_pages = [{'title': page.title, 'slug': page.slug} for page in WikiPage.query.order_by(WikiPage.title).all()]
    return render_template('rules/exotic_substances/edit.html', substance=substance, types=types, wiki_pages=wiki_pages, ScienceType=ScienceType)
