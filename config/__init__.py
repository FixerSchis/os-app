...
class Config:
    ...
    SECRET_KEY = os.environ.get("SECRET_KEY", "your-secret-key-here")  # Use env var
    ...
    MAIL_PASSWORD = os.environ.get("MAIL_PASSWORD", "replace-this-in-production")  # Use env var
